...
module.exports = () => {
	...
	if (tokensExist) {
		...
		fs.writeFileSync(`${distStringFile}.cjs`, `module.exports = \`${tokensArrayFilteredAndTrimmedAndJoined}\`;`);
		fs.writeFileSync(`${distStringFile}.js`, `export default \`${tokensArrayFilteredAndTrimmedAndJoined}\`;`);
	}
};
