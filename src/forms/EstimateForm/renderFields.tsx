...
const resolvedFieldType = (fieldType: FieldBag['type']) =>
	/checkbox|radio|file|select/.test(fieldType)
		? (fieldType as 'checkbox' | 'radio' | 'file' | 'select')
		: 'default';
export const renderFields = (errors: ApiErrorBag, hideTitles = false) =>
				...
				{group.fields.map(
					({ helperText, span, ...field }, fieldIndex) => {
						const InputComponent =
							inputTypeMap[resolvedFieldType(field.type)];
