...
export type ButtonStyledFunc = (props: ButtonStyledFuncProps) => string | CSSObject;
...
export const getButtonTextColors: ButtonStyledFunc = ({theme, color = 'text'}) => ({
...
export const getButtonHoverColors: ButtonStyledFunc = ({theme, color = 'text'}) => ({
