...
export const generateOptions = (n = 5): OptionValue[] => chance.n(() => {
...
export const generateBanner = (): BannerProps => ({
	title: "⚡️ It's sash season!!",
	description:
		"Come into the shop today to get your custom sash or schedule a consult online! Don't wait too long, spots are filling up.",
	actions: [
		{
			label: 'Book a Time'
		}
