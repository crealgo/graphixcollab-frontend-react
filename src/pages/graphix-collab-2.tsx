					...
					<div className="mx-auto max-w-7xl px-6 lg:px-8">
						<div className="mx-auto max-w-2xl text-center">
							...
							<p className="mt-6 text-lg leading-8 text-gray-600">
								We are a creative design studio that specializes
								in bringing your visual ideas to life. Our team
								of skilled and passionate graphic designers work
								collaboratively to create stunning visuals that
								capture attention, communicate messages, and
								elevate your brand to new heights. Whether you
								need a captivating logo, eye-catching packaging,
								or engaging marketing materials, we have the
								expertise and creativity to deliver exceptional
								results.
							</p>
			...
			<div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
				<div className="mx-auto max-w-2xl lg:text-center">
					...
					<p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
						We offer a wide range of graphic design services to meet the diverse needs of our clients. Our services include:
					</p>
					<p className="mt-6 text-lg leading-8 text-gray-600">
