...
const content = (
	<>
		...
		<p>
			...
			recorded by Graphix Collab and how we use it.
		</p>
		<p>
		...
		<p>
			...
			that they shared and/or collect in Graphix Collab. This policy is
		...
		<h2>Log Files</h2>
		<p>
			Graphix Collab follows a standard procedure of using log files.
		...
		<p>
			Like any other website, Graphix Collab uses "cookies". These cookies
		...
		<p>
			...
			advertising partners of Graphix Collab.
		</p>
		<p>
			Third-party ad servers or ad networks uses technologies like
			cookies, JavaScript, or Web Beacons that are used in their
			respective advertisements and links that appear on Graphix Collab,
		...
		<p>
			Note that Graphix Collab has no access to or control over these
			cookies that are used by third-party advertisers.
		</p>
		<h2>Third Party Privacy Policies</h2>
		<p>
			Graphix Collab's Privacy Policy does not apply to other advertisers
		...
		<p>
			Graphix Collab does not knowingly collect any Personal Identifiable
