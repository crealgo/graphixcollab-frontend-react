...
import {BlogBlock} from '@graphixcollab/components/BlogBlock';
...
const content = (
	<>
		...
		<p>Welcome to Graphix Collab!</p>

		<p>
			These terms and conditions outline the rules and regulations for the
			use of Graphix Collab's Website, located at graphixcollab.com.
		</p>

		<p>
			By accessing this website we assume you accept these terms and
			conditions. Do not continue to use Graphix Collab if you do not
		...
		<p>
			We employ the use of cookies. By accessing Graphix Collab, you
			agreed to use cookies in agreement with the Graphix Collab's Privacy
			Policy.
		</p>
		...
		<p>
			Unless otherwise stated, Graphix Collab and/or its licensors own the
			intellectual property rights for all material on Graphix Collab. All
			intellectual property rights are reserved. You may access this from
			Graphix Collab for your own personal use subjected to restrictions
			set in these terms and conditions.
		</p>

		<p>You must not:</p>
		<ul>
			<li>Republish material from Graphix Collab</li>
			<li>Sell, rent or sub-license material from Graphix Collab</li>
			<li>Reproduce, duplicate or copy material from Graphix Collab</li>
			<li>Redistribute content from Graphix Collab</li>
		</ul>
		...
		<p>
			...
			Graphix Collab does not filter, edit, publish or review Comments
			prior to their presence on the website. Comments do not reflect the
			views and opinions of Graphix Collab,its agents and/or affiliates.
			...
			Graphix Collab shall not be liable for the Comments or for any
		...
		<p>
			Graphix Collab reserves the right to monitor all Comments and to
		...
		<p>
			You hereby grant Graphix Collab a non-exclusive license to use,
		...
		<p>
			...
			visibility of the hyperlink compensates the absence of Graphix
			Collab; and (d) the link is in the context of general resource
			information.
		</p>
		...
		<p>
			...
			sending an e-mail to Graphix Collab. Please include your name, your
		...
		<p>
			No use of Graphix Collab's logo or other artwork will be allowed for
